...
import { ITimesRepository } from '@modules/staff/repositories/ITimesRepository';
...
import { CreateAppointmentConnError } from '@modules/player/useCases/CreateAppointment/errors/CreateAppointmentConnError';
import { CreateAppointmentTimeAlreadyInUse } from '@modules/player/useCases/CreateAppointment/errors/CreateAppointmentTimeAlreadyInUse';
import { CreateAppointmentTimeNotFound } from '@modules/player/useCases/CreateAppointment/errors/CreateAppointmentTimeNotFound';
import { CreateAppointmentUserNotFound } from '@modules/player/useCases/CreateAppointment/errors/CreateAppointmentUserNotFound';
    ...
    try {
      ...
      await Discord.REST.sendMessage(
        `<@${member.id}> agendou uma entrevista para: **${toUnix.format(
          'DD/MM/YYYY'
        )}** ás **${toUnix.get('hour')}:${toUnix.get('minute')}** com **${username.value
        }** :gun:`,
