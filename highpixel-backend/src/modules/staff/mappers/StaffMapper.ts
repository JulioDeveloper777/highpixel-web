import { Staff as PersistenceStaff, Time as PersistenceTimes } from '@prisma/client';
import { Staff } from '@modules/staff/domain/Staff';
import { Times } from '@modules/staff/domain/Times';
import { TimeMapper } from '@modules/staff/mappers/TimeMapper';
