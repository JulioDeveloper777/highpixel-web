...
import { WhitelistCustomError } from '@modules/staff/useCases/Whitelist/error/WhitelistCustomError';
...
import { WhitelistMentiondUseNotExist } from '@modules/staff/useCases/Whitelist/error/WhitelistMentiondUseNotExist';
    ...
    if (status === 'ENTREVISTADO') {
      ...
      try {
        ...
        await Discord.REST.addGuildMemberRole(
          ...
          member.id,
          process.env.BOT_DISCORD_HIGHPIXEL_APPOINTMENT_OK
        );
