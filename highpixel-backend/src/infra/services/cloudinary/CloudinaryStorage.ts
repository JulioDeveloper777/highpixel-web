...
import { Storage } from '@infra/libs/cloudinary/storage';
import { v2 as cloudinary } from 'cloudinary';
import { CloudinaryErrorUpload } from '@infra/services/cloudinary/errors/CloudinaryErrorUpload';
...
class CloudinaryDeleteService {
  ...
  private async delete(publicId: string, type: keyof typeof CloudinaryDeleteService.deleteConfig) {
    try {
      ...
      throw new CloudinaryErrorUpload();
    }
  }
